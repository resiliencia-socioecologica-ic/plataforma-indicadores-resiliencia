...
const DownloadHandler = (() => {
    ...
    const downloadPdf = async (dimensionNumber = null) => {
        ...
        currentY = addFormattedText("Este sistema de indicadores:", pageMargin, currentY, { spaceAfter: LIST_ITEM_SPACING, isParagraph: false });
        ...
        currentY = addFormattedText("Os indicadores não realizam uma avaliação concreta de mudanças comportamentais, mas a sua aplicação permite identificar as percepções da comunidade escolar sobre os efeitos das práticas na vida dos estudantes e em suas comunidades, além de apontar aspectos que orientem estratégias de melhoria.", pageMargin, currentY, { spaceAfter: PARAGRAPH_SPACING, isParagraph: true });
